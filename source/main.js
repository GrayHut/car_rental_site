...
tabs.addEventListener("click", (e) => {
    const tabContents = document.querySelectorAll(".deals-container .tab-content");
...
ScrollReveal().reveal("subscribe-image .section-description", {
    ...scrollRevealOption,
    delay: 1000,
});

ScrollReveal().reveal("subscribe-image form", {
    ...scrollRevealOption,
    delay: 1500,
});
